...
public class FActivityBusinessHolder
{
    ...
    private FActivityBusinessHolder(Activity activity)
    {
        if (activity == null)
    ...
    private static final Map<Activity, FActivityBusinessHolder> MAP_HOLDER = new WeakHashMap<>();

    public static synchronized FActivityBusinessHolder get(Activity activity)
    {
        if (activity == null)
            return null;

        FActivityBusinessHolder holder = MAP_HOLDER.get(activity);
        if (holder == null)
        {
            holder = new FActivityBusinessHolder(activity);
